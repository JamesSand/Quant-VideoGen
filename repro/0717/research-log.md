...
| 15 | **N12：K/V 双侧字典 + asym B128 残差 + fp8 逐事件表**（SAS 平滑 × 我们的量化格） | LC 跑中 | — | BPE：LC 2.257 / HY ~2.30 ✓；若 V 侧字典收复平台（→35），HY 全程应显著超 18.77 |
| 16 | N10b：N10 + iters50 + V r=5（收 0.051 dB 的精修臂） | LC/HY 跑中 | — | BPE：HY 2.314 / LC 2.294 ✓ |
