...
- **QVG-Pro 的优势几乎全来自 B=16，而非 S=4**：QVG S=1/B=16 = 30.96，QVG-Pro S=4/B=16 = 31.04——四轮渐进 k-means（4 套质心表 + 4 份索引，метadata 翻倍、4 倍聚类成本）只贡献 **+0.08 dB**；而同样 S=1 下 B=64→16 贡献 +2.08 dB。**"QVG-Pro ≈ QVG + 细 scale"**。
