...
| | **QuaRot 非对称 B16 + clip(ratio=0.99)** | **30.68** | — | 6.40× | 本日新增，超无 clip 基线 +0.30 |
...
| | **QuaRot 非对称 B16 + clip(pct=99.7)** | **34.92** | — | 3.55× | 本日新增，超无 clip 基线 +1.88 |
...
**假设**：原始 KV 上裁剪是灾难（[CLIP_STUDY.md](../CLIP_STUDY.md)），但 Hadamard 把单点信息摊到全部坐标、分布高斯化之后，轻度裁剪应从"灾难"翻转为"小赚"。
