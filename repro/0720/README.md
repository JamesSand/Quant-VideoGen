...
> 指南);当天叙事见 [report-0720.md](report-0720.md);交接见
...
2. **kernel 三重门**:① BPE 逐字节审计合规([bpe-audit.md](bpe-audit.md):
   LC 2.3192 / SF 2.3183 / HY cache 2.3250,全 ≤2.326);② 同输入 encode 快过
   QVG kmeans([kernel-results.md](kernel-results.md):LC 32.5× / HY 1.4× /
   SF 1.1×,Triton fused decode 与参考逐位一致);③ 质量无一列输 QVG;
...
| [report-0720.md](report-0720.md) / [HANDOFF-0720.md](HANDOFF-0720.md) | 当日叙事 / 交接 |
...
| `jobs_m1regen.txt` 等 | 记账修正后重赛的任务清单 |
| `lc_p1_f93_comparison.png` + `lc_f93_grids/` + `hy_videos/` | 可视化素材(f93 对比、10 网格、6 个 HY mp4,用户点名入库) |
