...
- **已定:kernel 化 + 同输入速度对决**,plan 见 [kernel-plan.md](kernel-plan.md);**为什么赢的方法论分析** plan 见 [why-analysis-plan.md](why-analysis-plan.md)。其余候选:候选(承接 HANDOFF):剩余两列的 (a)收案/(b)解禁机制/(c)换口径;
