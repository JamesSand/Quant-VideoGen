...
减法阶段 kmeans 反而消得略多(原 H1 证伪,24/24;证据见负结果台账)——但它
把结构吃得太干净,残差≈白噪声:**其回收率在 LC/SF 全部 16 测点钉死在 46-49%**
(minmax 均匀 2-bit 格在白噪声上的教科书损失);我们只减"方向性"结构,把
逐通道幅度差留给通道轴格子,救回 ~76%。**chunk 级最终误差我们 20/24 格更小;
端到端 LC +3.48dB。**
