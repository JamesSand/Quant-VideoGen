# Report 0721 — Budget-PCA:方法 · 战绩 · Kernel · Why(基线 = 0720 终版)

> 本文件初始为 [../0720/report-0720.md](../0720/report-0720.md) 的副本(0721 开工基线,链接已指回 0720 资产);本日新增内容在此基础上迭代。
...
![fig3:残差格效率——QVG 回收 ~48%(白噪声水平)vs 我们 ~75%](../0720/why/fig3_residual_efficiency.png)
...
> 都不做——但两家的败点恰好互补:
> 1. **QVG 的努力用错了阶段**(§4.1):减法消掉 91.6% 之后,剩下的残差
>    ≈白噪声,它的 token 轴 2-bit 格只能回收 48%——最终误差 4.38%;
