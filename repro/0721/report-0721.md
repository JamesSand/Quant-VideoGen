...
> 本文件为 [../0720/report-0720.md](../0720/report-0720.md) 的同步副本(链接指回 0720 资产);0721 新增:§4.1 归因修正(grid_cross)+ pcatern/kivipost 归因臂。
...
(67%)仍低于我们(77%),且其字典元数据实测已超预算;**端到端反向验证**:
把我们的残差格换成同款三电平(pcatern 臂,10 prompts)→ 31.7 掉到 **23.97**
且跌破 QVG 的 27.61——同格子时减法强者赢,胜利确属格子。**chunk 级最终误差
