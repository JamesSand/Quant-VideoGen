...
| 方法（INT2） | PSNR ↑ | SSIM ↑ | LPIPS ↓ | BPE ↓ |
|---|---:|---:|---:|---:|
| QVG（我们实测） | 28.73 | 0.9033 | 0.089 | 2.326 |
| QVG（paper Table 1） | 28.716 | 0.909 | 0.065 | 2.31（由 6.94× 折算） |
| **N4（我们）** | **31.79** | **0.9424** | **0.067** | **2.253**（真实现 2.3125） |
...
- 对 paper 最强档 QVG-Pro（我们实测 31.04 @BPE 3.22）：N4 PSNR 仍高 0.75 dB，
  BPE 只有其 70%。
