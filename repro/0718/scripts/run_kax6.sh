...
grep -v '^hy' repro/0718/jobs_kax6.txt > /tmp/kax6_lcsf.txt
grep '^hy' repro/0718/jobs_kax6.txt > /tmp/kax6_hy.txt
bash repro/0718/scripts/gpu_queue.sh /tmp/kax6_lcsf.txt 8
unset CAMPAIGN_NS CAMPAIGN_PROMPTS CAMPAIGN_SF_DIR
bash repro/0718/scripts/gpu_queue.sh /tmp/kax6_hy.txt 8
echo KAX6 DONE
