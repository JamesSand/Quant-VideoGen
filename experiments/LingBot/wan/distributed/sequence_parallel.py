...
from ..modules.model_fast import _kv_storage_size, _kv_write, _kv_read
...
def sp_attn_forward_causal(
    ...
    if self.local_attn_size == -1:
        # Global cache (no eviction). With raw-tensor storage this is sync-free;
        # ChunkedKVCache does Python-int math inside write/read but no .item().
